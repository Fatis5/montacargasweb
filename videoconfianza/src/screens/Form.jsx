...
const Form = () => {
  ...
  return (
    ...
    >
      ...
      <label htmlFor="Nombre" className="text-white mt-2 mx-auto">
        Nombre
      </label>
      <input
        ...
        name="user_name"
      />
      <label htmlFor="Email" className="text-white mt-2 mx-auto text-xl">
        Email
      </label>
      <input className="rounded-lg mx-2 h-10" type="email" name="correo" />
      <label htmlFor="Teléfono" className="text-white mt-2 mx-auto text-xl ">
        Teléfono
      </label>
      <input
        ...
        name="telefono"
      />
      <label htmlFor="Mensaje" className="text-white mt-2 mx-auto text-xl">
        Mensaje
      </label>
      <textarea
        typeof="text"
        className="rounded-lg mx-2 h-20"
        rows="5"
        name="message"
      />
